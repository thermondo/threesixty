...
class Survey(models.Model):
    ...
    def get_manager_url(self):
        return reverse('survey-edit', kwargs={'pk': self.pk, 'token': self.get_token(self.manager_email)})

    def get_employee_url(self):
        return reverse('survey-view', kwargs={'pk': self.pk, 'token': self.get_token(self.employee_email)})
...
class Question(models.Model):
    ...
    connotation = models.BooleanField(_('connotation'), choices=CONNOTATIONS, default=True)
    created = models.DateTimeField(_('created'), auto_now_add=True, editable=False)
...
class Participant(models.Model):
    ...
    def get_absolute_url(self):
        ...
        return reverse('survey-answer', kwargs={'survey_pk': self.survey_id, 'token': token})
